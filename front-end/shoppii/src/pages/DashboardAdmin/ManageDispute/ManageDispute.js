...
export default function ManageComplaint() {
    ...
    useEffect(() => {
        setLoading(true);
        axios.get("http://localhost:9999/api/admin/disputes?skipAuth=true")
    ...
    const handleResolve = async () => {
        ...
        setSaving(true);
        await axios.put(`http://localhost:9999/api/admin/disputes/${selected._id}/resolve?skipAuth=true`, {
            resolution: resolveInput,
            status: resolveStatus,
        });
        // Refetch list
        const res = await axios.get("http://localhost:9999/api/admin/disputes?skipAuth=true");
