...
//     React.useState(false); // New state for Add Category Dialog
...
//     React.useState(""); // For category description input

//   // Fetch categories
//   React.useEffect(() => {
//     axios
//       .get("http://localhost:9999/api/admin/categories?skipAuth=true")
...
//         "http://localhost:9999/api/admin/products?skipAuth=true",
//         requestBody,
//         {
//           headers: {
...
//     try {
//       const result = await axios.post(
//         "http://localhost:9999/api/admin/categories?skipAuth=true",
//         requestBody,
//         {
//           headers: {
//             "Content-Type": "application/json",
...
//         <DialogContent>
//           <DialogContentText>
//             To add new products to the store, please fill out the information
