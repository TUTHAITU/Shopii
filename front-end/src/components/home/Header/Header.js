                  ...
                  {isAuthenticated ? (
                    <div className="flex items-center ml-4 space-x-4">
                      ...
                      <button 
                        ...
                        className="bg-blue-600 text-white px-4 py-1 rounded hover:bg-blue-700 duration-300"
                      >
                        Đăng xuất
                      </button>
                    </div>
                    ...
                    <div className="flex items-center ml-4 space-x-4">
                      <Link to="/signin">
                        <button className="bg-blue-600 text-white px-4 py-1 rounded hover:bg-blue-700 duration-300">
                          Đăng nhập
                        </button>
                      </Link>
                      <Link to="/signup">
                        <button className="bg-green-600 text-white px-4 py-1 rounded hover:bg-green-700 duration-300">
                          Đăng ký
                        </button>
                      </Link>
                    </div>
                ...
                >
                  <div className="w-full h-full bg-primeColor p-6">
                    ...
                    <ul className="text-gray-200 flex flex-col gap-2">
                      ...
                      {/* Phần người dùng trong menu mobile */}
                      {isAuthenticated ? (
                        <>
